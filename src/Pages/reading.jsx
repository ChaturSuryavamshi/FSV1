...
export default function Reading() {
  ...
  // Show cards only on the base route: /dashboard/readings
  const isOnBasePath = location.pathname === "/dashboard/readings";
    ...
    <div>
      {isOnBasePath && (
        <div className="grid grid-cols-3 p-8 gap-6">
          <div
            onClick={() => navigate('/dashboard/readings/closing-opening-readings')}
            className="cursor-pointer bg-white border-4 border-black p-5 sm:p-6 shadow-[6px_6px_0_0_rgba(0,0,0,1)] rounded-xl hover:translate-y-[-4px] transition-transform duration-300"
          >
          ...
          <div
            onClick={() => navigate('/dashboard/readings/submitted-readings')}
            className="cursor-pointer bg-white border-4 border-black p-5 sm:p-6 shadow-[6px_6px_0_0_rgba(0,0,0,1)] rounded-xl hover:translate-y-[-4px] transition-transform duration-300"
          >
